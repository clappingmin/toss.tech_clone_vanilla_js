  ...
  render() {
    ...
    <ul class="footer-social">
      <li class="footer-social__item">
        <a><img src="src/assets/icon-facebook.svg" /></a>
      </li>
      <li class="footer-social__item">
        <a><img src="src/assets/icon-blog.svg" /></a>
      </li>
      <li class="footer-social__item">
        <a><img src="src/assets/icon-naver.svg" /></a>
      </li>
      <li class="footer-social__item">
        <a><img src="src/assets/icon-twitter.svg" /></a>
      </li>
      <li class="footer-social__item">
        <a><img src="src/assets/icon-instagram.svg" /></a>
      </li>
    </ul>
  </div>
    `;
